...
// tree read it, so it was an accumulator, not state. Four owned containers at 24
// bytes each now, +56 over the C++'s 360. The pin stays for what it always caught.
assert_size!(SWelsSvcRc, 416);
