...
mod tests {
    ...
    /// Four anchors covering every residue mod 4 (with residues [0, 3, 6, 5] mod 8), so the
    /// aligned case is not the only one tested. Each leaves at least 16 rows and 16 columns of margin on all sides.
