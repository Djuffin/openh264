...
pub fn sample_sad_16x16<S: RefSamples>(sample1: &S, sample2: &S) -> i32 {
    sample_sad::<16, 16, _>(sample1, sample2)
}
...
pub fn sample_sad_16x8<S: RefSamples>(sample1: &S, sample2: &S) -> i32 {
    sample_sad::<16, 8, _>(sample1, sample2)
}
