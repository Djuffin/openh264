...
fn test_single_bitstream_asset_ex(file_name: &str, expected_hash: &str, hash_concealed: bool) {
    ...
    unsafe {
        ...
        assert_eq!(
            init_ret, CM_RESULT_SUCCESS as i64,
        ...
        for _f in 0..remaining_frames {
            ...
            if (hash_concealed || flush_ret == DECODING_STATE::dsErrorFree)
                && buf_info.iBufferStatus == 1
            {
                update_hash_from_frame(&mut hasher, p_dst, &buf_info);
                decoded_frames += 1;
...
asset_test!(
    test_asset_ba_mw_d,
    "BA_MW_D.264",
    "afd7a9765961ca241bb4bdf344b31397bec7465a"
);
asset_test!(
    test_asset_adobe_pdf_sample_a_1024x768_50frms,
    "Adobe_PDF_sample_a_1024x768_50Frms.264",
    "9aa9a4d9598eb3e1093311826844f37c43e4c521"
);
asset_test!(
    test_asset_ba1_ft_c,
    "BA1_FT_C.264",
    "418d152fb85709b6f172799dcb239038df437cfa"
);
asset_test!(
    test_asset_ba1_sony_d,
    "BA1_Sony_D.jsv",
    "d94b5ceed5686a03ea682b53d415dee999d27eb6"
);
asset_test!(
    test_asset_bamq1_jvc_c,
    "BAMQ1_JVC_C.264",
    "613cf662c23e5d9e1d7da7fe880a3c427411d171"
);
asset_test!(
    test_asset_bamq2_jvc_c,
    "BAMQ2_JVC_C.264",
    "11bcf3713f520e606a8326d37e00e5fd6c9fd4a0"
);
asset_test!(
    test_asset_banm_mw_d,
    "BANM_MW_D.264",
    "92d924a857a1a7d7d9b224eaa3887830f15dee7f"
);
asset_test!(
    test_asset_basqp1_sony_c,
    "BASQP1_Sony_C.jsv",
    "3986c8c9d2876d2f0748b925101b152c6ec8b811"
);
asset_test!(
    test_asset_ci1_ft_b,
    "CI1_FT_B.264",
    "cbfec15e17a504678b19a1191992131c92a1ac26"
);
asset_test!(
    test_asset_ci_mw_d,
    "CI_MW_D.264",
    "289f29a103c8d95adf2909c646466904be8b06d7"
);
asset_test!(
    test_asset_cvfc1_sony_c,
    "CVFC1_Sony_C.jsv",
    "4641abd7419a5580b97f16e83fd1d566339229d0"
);
asset_test!(
    test_asset_cvpcmnl1_sva_c,
    "CVPCMNL1_SVA_C.264",
    "c2b0d964de727c64b9fccb58f63b567c82bda95a"
);
asset_test!(
    test_asset_ls_sva_d,
    "LS_SVA_D.264",
    "72118f4d1674cf14e58bed7e67cb3aeed3df62b9"
);
asset_test!(
    test_asset_midr_mw_d,
    "MIDR_MW_D.264",
    "9467030f4786f75644bf06a7fc809c36d1959827"
);
asset_test!(
    test_asset_mps_mw_a,
    "MPS_MW_A.264",
    "67f1cfbef0e8025ed60dedccf8d9558d0636be5f"
);
asset_test!(
    test_asset_mr1_bt_a,
    "MR1_BT_A.h264",
    "6e585f8359667a16b03e5f49a06f5ceae8d991e0"
);
asset_test!(
    test_asset_mr1_mw_a,
    "MR1_MW_A.264",
    "d9e2bf34e9314dcc171ddaea2c5015d0421479f2"
);
asset_test!(
    test_asset_mr2_mw_a,
    "MR2_MW_A.264",
    "628b1d4eff04c2d277f7144e23484957dad63cbe"
);
asset_test!(
    test_asset_mr2_tandberg_e,
    "MR2_TANDBERG_E.264",
    "74d618bc7d9d41998edf4c85d51aa06111db6609"
);
asset_test!(
    test_asset_nl1_sony_d,
    "NL1_Sony_D.jsv",
    "e401e30669938443c2f02522fd4d5aa1382931a0"
);
asset_test!(
    test_asset_nlmq1_jvc_c,
    "NLMQ1_JVC_C.264",
    "f3265c6ddf8db1b2bf604d8a2954f75532e28cda"
);
asset_test!(
    test_asset_nlmq2_jvc_c,
    "NLMQ2_JVC_C.264",
    "350ae86ef9ba09390d63a09b7f9ff54184109ca8"
);
asset_test!(
    test_asset_nrf_mw_e,
    "NRF_MW_E.264",
    "20732198c04cd2591350a361e4510892f6eed3f0"
);
asset_test!(
    test_asset_qcif_2p_i_allipcm,
    "QCIF_2P_I_allIPCM.264",
    "8724c0866ebdba7ebb7209a0c0c3ae3ae38a0240"
);
asset_test!(
    test_asset_sva_ba1_b,
    "SVA_BA1_B.264",
    "c4543b24823b16c424c673616c36c7f537089b2d"
);
asset_test!(
    test_asset_sva_ba2_d,
    "SVA_BA2_D.264",
    "98ff2d67860462d8d8bcc9352097c06cc401d97e"
);
asset_test!(
    test_asset_sva_base_b,
    "SVA_Base_B.264",
    "91f514d81cd33de9f6fbf5dbefdb189cc2e7ecf4"
);
asset_test!(
    test_asset_sva_cl1_e,
    "SVA_CL1_E.264",
    "4fe09ab6cdc965ea10a20f1d6dd38aca954412bb"
);
asset_test!(
    test_asset_sva_fm1_e,
    "SVA_FM1_E.264",
    "fad08c4ff7cf2307b6579853d0f4652fc26645d3"
);
asset_test!(
    test_asset_sva_nl1_b,
    "SVA_NL1_B.264",
    "6d63f72a0c0d833b1db0ba438afff3b4180fb3e6"
);
asset_test!(
    test_asset_sva_nl2_e,
    "SVA_NL2_E.264",
    "70453ef8097c94dd190d6d2d1d5cb83c67e66238"
);
asset_test!(
    test_asset_sarvui,
    "SarVui.264",
...
asset_test!(
    test_asset_static,
    "Static.264",
    "91dd4a7a796805b2cd015cae8fd630d96c663f42"
);
asset_test!(
    test_asset_zhling_1280x720,
    "Zhling_1280x720.264",
    "ad99f5eaa2d73ae3840e7da67313de8cfc866ce6"
);
asset_test!(
    test_asset_sps_subsetsps_bothvui,
    "sps_subsetsps_bothVUI.264",
    "d3a47032eb5dcc1963343a68e9bea12435bf1e4c"
);
asset_test!(
    test_asset_test_cif_i_cabac_pcm,
    "test_cif_I_CABAC_PCM.264",
    "95fdf21470d3bbcf95505abb2164042063a79d98"
);
asset_test!(
    test_asset_test_cif_i_cabac_slice,
    "test_cif_I_CABAC_slice.264",
    "19121bc67f2b13fb8f030504fc0827e1ac6d0fdb"
);
asset_test!(
    test_asset_test_cif_p_cabac_slice,
    "test_cif_P_CABAC_slice.264",
    "521bbd0ba2422369b724c7054545cf107a56f959"
);
asset_test!(
    test_asset_test_qcif_cabac,
    "test_qcif_cabac.264",
...
asset_test!(
    ...
    "f690a3af2896a53360215fb5d35016bfd41499b3"
);
asset_test!(
    test_asset_test_vd_1d,
    "test_vd_1d.264",
    "5827d2338b79ff82cd091c707823e466197281d3"
);
asset_test!(
    test_asset_test_vd_rc,
    "test_vd_rc.264",
    "eea02e97bfec89d0418593a8abaaf55d02eaa1ca"
);
asset_test!(
...
asset_test!(
    ...
    "Cisco_Adobe_PDF_sample_a_1024x768_CAVLC_Bframe_9.264",
    "9d758d9e6f4dead0d7b361f3ddf2ee009d0ea190"
);
asset_test!(
...
asset_test!(
    ...
    "narrow_16x16.264",
    "6299ce8a7dc8a86d367dca65ca123eb499fc5ca8"
);
asset_test!(
    test_asset_narrow_24x18,
    "narrow_24x18.264",
    "f6197477215d8847b570982d3c2747da2911f047"
);
...
asset_test_concealed!(
    test_asset_narrow_16x16_idr_lost,
    "narrow_16x16_idr_lost.264",
    "754db24b395cc7aff338e036a416a9b5bb409c81"
);
...
asset_test!(
    ...
    "grid_48x32.264",
    "a56242a64a22edee058cd9cd14179f54bcd79b97"
);
...
// `bFreezeOutput`.
asset_test_concealed!(
    test_asset_ba_mw_d_idr_lost,
    "BA_MW_D_IDR_LOST.264",
    "f31e54a50296406f7f55d95c959e800d5dfbbe44"
);
asset_test_concealed!(
    test_asset_ba_mw_d_p_lost,
    "BA_MW_D_P_LOST.264",
    "66ec2f1d66356de3dfadffa298bbe838347a9eb1"
);
