...
- **S14 — the F3 protocol** (text refreshed 2026-08-11 to the measured facts;
  history in `phase0_findings.md` F3 — thirty-eight measurements, thirteen
  alternations, seventeen acquittals). **Signature:** `mt`, `sm=3`, `t∈{2,4}`, output
