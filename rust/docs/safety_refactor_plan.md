...
| **Next** | **Phase 5 — the decoder structural rewrite, the plan's first pivot** (9–12 sessions), **in progress, sessions A–Q**. **W3's flip landed (session Q, `a8eaa3e5`)** and with it
