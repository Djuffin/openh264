...
| POC tiebreak | **1** | `HashFunctions.h:20` (`DecoderOutputTest/39`, `test_scalinglist_jm.264`) | `decoder_conformance_test.rs:238`, deliberate | **D-poc-1**: keep (JVT-correct) or match upstream — the user's call; allowlisted with the reason meanwhile |
