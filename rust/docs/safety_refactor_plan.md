...
- **S32 — the Miri gate's cost is decoder instantiations, not decoded
  ...
  * **S32 transfers to the encoder on picture size, measured.** Encoder
    ...
    0.13% null band. The cost is the instantiation there too, so a probe's geometry
