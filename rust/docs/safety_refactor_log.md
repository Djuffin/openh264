...
**The span** (7 pairs against `d7af280d`, `perf_baseline.md`): encode median **+0.00%**, max **+1.52%**, min −1.33%, zero rows over 5%, against a fresh 3-pair null of median +0.16% / max +1.52% — **the same maximum row**. Decode median **−0.24%** against −0.11%. Cumulative encoder deficit ≈ **+10…+12%**, unmoved; the +25% tripwire unbreached by ~23 points. **S33 applies**: nothing is claimed in either direction, and no swap landed in step 5 so there is no ledger row to open.
